      ...
      >
        <div className="mb-4">
          <div className="relative">
            <input
              ...
              className="transition-color peer w-full rounded-2xl border border-border-light bg-surface-primary px-3.5 pb-2.5 pt-3 text-text-primary duration-200 focus:border-green-500 focus:outline-none"
              placeholder=" "
            />
            <label
              htmlFor="email"
        ...
        <div className="mb-2">
          <div className="relative">
            <input
              ...
              className="transition-color bg-grey-900 peer w-full rounded-2xl border border-border-light bg-surface-primary px-3.5 pb-2.5 pt-3 text-text-primary duration-200 focus:border-green-500 focus:outline-none"
              placeholder=" "
            />
            <label
              htmlFor="password"
        ...
        <div className="mt-6">
          <button
            ...
            type="submit"
            className="text-b dark:bg-grey-600 w-full rounded-2xl bg-green-600 px-4 py-3 text-sm font-medium transition-colors hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2 disabled:opacity-50 disabled:hover:bg-green-600 dark:text-white dark:hover:bg-green-700"
          >
