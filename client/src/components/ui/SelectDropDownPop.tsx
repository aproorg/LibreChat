        ...
        <div className={'relative w-full'}>
          <Trigger asChild>
            <button
              ...
              className={cn(
                'pointer-cursor relative flex flex-col rounded-lg border border-black/10 bg-white py-2 pl-3 pr-10 text-left focus:ring-0 focus:ring-offset-0 sm:text-sm',
                'hover:bg-gray-50 radix-state-open:bg-gray-50',
            ...
            >
              ...
              <span className="inline-flex w-full">
                <span
                  className={cn(
                    'flex h-6 items-center gap-1 text-sm text-secondary',
                    !showLabel ? 'text-xs' : '',
          ...
          <Portal>
            <Content
              ...
              align="start"
              className={cn(
                'mr-3 mt-2 max-h-[52vh] w-full max-w-[85vw] overflow-hidden overflow-y-auto rounded-lg border border-gray-200 bg-white shadow-lg sm:max-w-full lg:max-h-[52vh]',
