  ...
  return (
    <Popover.Portal>
      <Popover.Content
        ...
        sideOffset={12}
        alignOffset={-5}
        className="w-18 min-w-[180px]  max-w-sm rounded-lg px-1"
      >
        <div tabIndex={-1}>
          <div className="max-w-sm rounded-md p-2 shadow-[0_0_24px_0_rgba(0,0,0,0.05),inset_0_0.5px_0_0_rgba(0,0,0,0.05),0_2px_8px_0_rgba(0,0,0,0.05)]">
            <div className="mb-2 text-sm font-medium">{title}</div>
            <div className="dark rounded-md text-xs">
              <div className="max-h-32 overflow-y-auto rounded-md p-2">
