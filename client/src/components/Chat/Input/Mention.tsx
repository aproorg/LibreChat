...
export default function Mention({
  ...
  return (
    <div className="absolute bottom-14 z-10 w-full space-y-2">
      <div className="popover border-token-border-light rounded-2xl border bg-white p-2 shadow-lg">
        <input
          ...
          className="mb-1 w-full border-0 bg-white p-2 text-sm focus:outline-none"
          autoComplete="off"
          value={searchValue}
          onKeyDown={(e) => {
            if (e.key === 'Escape') {
