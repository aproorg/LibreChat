...
export default function McpSection({ item }: Props) {
  ...
  /** Server-level `deferLoading` acts as the default every per-tool defer
   *  control resolves against, so a tool with no explicit option follows the
   *  server and only divergences are persisted. */
